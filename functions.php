<?php
	function DH_files(){
		...
		// wp_enqueue_style('DH_main_styles', get_stylesheet_uri());
		if(strstr($_SERVER['SERVER_NAME'],'digital-humanities-capstone-project.local')){
			...
			wp_enqueue_script('main-JS', get_theme_uri('/bundled-assets/scripts.73aa0213b8bfede56f10.js'), NULL, '1.0', true);
			wp_enqueue_style('main-CSS', get_theme_uri('/bundled-assets/styles.73aa0213b8bfede56f10.css'));
		}
	}
